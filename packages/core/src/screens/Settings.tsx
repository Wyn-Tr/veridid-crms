...
const Settings: React.FC<SettingsProps> = ({ navigation }) => {
  ...
  settingsSections.push({
    header: {
      icon: { name: 'science' },
      title: t('Settings.BetaFeatures'),
    },
    data: [
      {
        title: t('Settings.BetaFeatures'),
        value: store.preferences.usePOEFeatures ? t('Global.On') : t('Global.Off'),
        accessibilityLabel: t('Settings.BetaFeatures'),
        testID: testIdWithKey('BetaFeatures'),
        onPress: () => navigation.navigate(Screens.BetaFeatures),
      },
    ],
  })
