...
// POE Proof result types
export interface POETimeProofResult {
  timestamp: number
  blockNumber: number
  drift: number
  isValid: boolean
...
export interface POELocationProofResult {
  timestamp: number
  latitude: number
  longitude: number
...
export interface Preferences {
  ...
  // POE Beta Features
  usePOEFeatures?: boolean
  poeTimeProofEnabled?: boolean
  poeLocationProofEnabled?: boolean
  poeLastTimeProof?: POETimeProofResult
  poeLastLocationProof?: POELocationProofResult
}
