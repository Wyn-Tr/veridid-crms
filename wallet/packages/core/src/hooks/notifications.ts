...
import { OpenId4VciPendingCredentialOffer, OpenId4VPRequestRecord } from '../modules/openid/types'
import { useReplacementNotifications } from '../modules/openid/hooks/useReplacementNotifications'
import { usePendingWorkflows } from './useWorkflows'
...
export const useNotifications = ({
  ...
  const { pendingWorkflows } = usePendingWorkflows()
  ...
  useEffect(() => {
    ...
    const openIDCreds: Array<
      SdJwtVcRecord | W3cCredentialRecord | MdocRecord | OpenId4VciPendingCredentialOffer | OpenId4VPRequestRecord
    > = []
