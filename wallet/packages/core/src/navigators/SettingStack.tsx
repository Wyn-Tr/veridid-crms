...
import BetaFeatures from '../screens/BetaFeatures'
...
const SettingStack: React.FC = () => {
  ...
  return (
    <Stack.Navigator screenOptions={{ ...defaultStackOptions }}>
      ...
      />
      <Stack.Screen
        name={Screens.BetaFeatures}
        component={BetaFeatures}
        options={{
          title: t('Screens.BetaFeatures'),
          headerBackTestID: testIdWithKey('Back'),
          ...ScreenOptionsDictionary[Screens.BetaFeatures],
        }}
      />
      <Stack.Screen
        ...
        options={{
          ...
          headerBackTestID: testIdWithKey('Back'),
          ...ScreenOptionsDictionary[Screens.POETimeProof],
        }}
      />
      <Stack.Screen
        ...
        options={{
          ...
          headerBackTestID: testIdWithKey('Back'),
          ...ScreenOptionsDictionary[Screens.POELocationProof],
        }}
      />
    </Stack.Navigator>
  )
