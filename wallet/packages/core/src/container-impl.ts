...
import ESSICredentialOfferAccept from './screens/essi/ESSICredentialOfferAccept'
...
export class MainContainer implements Container {
  ...
  public init(): Container {
    ...
    this._container.registerInstance(TOKENS.SCREEN_CHAT, ESSIChat)
    ...
    this._container.registerInstance(TOKENS.NAV_TAB_STACK, TabStack)
    ...
    this._container.registerInstance(TOKENS.COMPONENT_CREDENTIAL_OFFER_ACCEPT, ESSICredentialOfferAccept)
    ...
    this._container.registerInstance(TOKENS.UTIL_AGENT_BRIDGE, agentBridge)
    agentBridge.onReady((agent) => ocaResolver.setAgent(agent), true)
