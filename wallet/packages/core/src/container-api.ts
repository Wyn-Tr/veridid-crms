...
import { CredentialOfferAcceptProps } from './screens/CredentialOfferAccept'
...
export const COMPONENT_TOKENS = {
  ...
  COMPONENT_CREDENTIAL_OFFER_ACCEPT: 'component.credential-offer-accept',
} as const
...
export type TokenMapping = {
  ...
  [TOKENS.SCREEN_PIN_CREATE]: React.FC
  [TOKENS.SCREEN_PIN_ENTER]: React.FC
  ...
  [TOKENS.NAV_TAB_STACK]: React.FC
  [TOKENS.COMPONENT_CONNECTION_ALERT]: React.FC<{ connectionLabel?: string }>
  [TOKENS.COMPONENT_CREDENTIAL_OFFER_ACCEPT]: React.FC<CredentialOfferAcceptProps>
